    ...
    public static ArrayList<Question> getQuestions(String topicid) {
     ...
     public static boolean storeSurveyResults(String topicid, ArrayList<Question> questions) {
        ...
        try {
            ...
            ps = con.prepareStatement("insert into answers_master values( surveyid_sequence,?,sysdate)");
            ps.setString(1, topicid);
            ps.executeUpdate();

            ps = con.prepareStatement("insert into answers_details values( surveyid_sequence, ?,?)");
